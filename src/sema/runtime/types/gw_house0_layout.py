...
class GwHouse0Layout(SemaType):
    ...
    def check_axiom_10(self) -> Self:
        ...
        "primary-pump-failsafe-relay", "primary-pump-scada-ops-relay",
        "hp-loop-on-off-relay", and "hp-loop-keep-send-relay", each with ActorClass
        "Relay", and nodes named "dist-010v", "primary-010v", and "store-010v", each
        with ActorClass "ZeroTenOutputer". b. Hydronic.ZoneCallCircuits SHALL be
        non-empty, and each circuit's FailsafeRelayNode and OpsRelayNode SHALL name a
        ShNode in ShNodes with ActorClass "Relay". c. Each of "dist-010v",
        "primary-010v" and "store-010v" SHALL have a ComponentId equal to the
    ...
    def check_axiom_11(self) -> Self:
        ...
        and "hp-idu" (a House0 home is a split system: the indoor unit does the
        refrigerant-to-water exchange), each with a ComponentId equal to the ComponentId
        of a Component in Components, and each with ActorClass "NoActor" unless it is
        the node Hydronic.HpCommandNodeName names, whose ActorClass CommandableHeatPump
        governs.
        """
